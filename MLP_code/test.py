...
def test_samples(net_file, net_para, test_samples_files, result_pth, name, bands,BN=False,Drop=0):
    '''
    ...
    def normalization(a):
        ...
        Morning_0830 = [[0.18124145, 0.109825015], [0.16228461, 0.112637654], [0.1378042, 0.12411338], [0.18292618, 0.139954], [0.10658425, 0.08359684],
                        [0.07185213, 0.064878836], [292.01236, 15.840933], [237.56929, 11.219984], [246.72728, 14.097755], [254.7297, 16.475685],
                        [279.74924, 25.043392], [263.3086, 16.001703], [281.65326, 25.890469], [280.4909, 26.321886], [277.268, 25.505695],
        ...
        for i in range(ary.shape[1] - 1):
            mean = Morning_0830[i][0]
            std = Morning_0830[i][1]
            ary[:, i] = (ary[:, i] - mean) / std
            print('第{}个波段'.format(i))
...
EveryPicName = '0830NoTrain_EveryPicture'#'fourdaysNoTrain_EveryPicture' #'0830NoTrain_EveryPicture'
AllTestName = '0830'#'fourdays'#'0830'
#net_files = glob.glob(r'E:\SmokeDetection\source\MLP_90_exp\4000_smoke\1\*f1.pth')
net_files = glob.glob(r'E:\SmokeDetection\source\MLP_cirrus_exp\50000_smokemorning\Morning_20220617\*loss.pth')
for net_file in net_files:
    ...
    net_para = (len(bands), 2, 256, 3, 1, 0.8) #超参数定义！！！！！！！！！！！！！！
    ...
    test_samples_files = glob.glob(r'E:\SmokeDetection\source\test_data\0830\*.tif')[:6]
    result_pth = filePath
